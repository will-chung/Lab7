...
router.setState = function(state) {
  ...
  if (state.className == 'settings') {
    title.innerHTML = 'Settings';
  } else if (state.className == 'single-entry') {
    let entryPage = document.createElement('entry-page')
    title.innerHTML = 'Entry ' + state.entryNumber;
    document.querySelector('entry-page').remove();
    document.querySelector('main').insertAdjacentElement('afterend', entryPage);
